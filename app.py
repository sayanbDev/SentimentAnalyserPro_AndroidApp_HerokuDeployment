...
def home():
    ...
    api = tweepy.API(auth)
    tweets = api.search('BJP -filter:retweets', result_type="popular", lang="en",tweet_mode="extended",count=100)
...
def get_text_prediction():
    ...
    if no_of_tweets<0 or no_of_tweets>100:
        ...
        tweets = api.search(search, result_type="popular", lang="en",tweet_mode="extended",count=no_of_tweets)
